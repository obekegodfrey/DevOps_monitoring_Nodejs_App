...
docker login -u 
obekegodfrey2@gmail.com
password: 

docker tag node-k8s-demo obekegodfreyvicent/node-k8s-demo:latest
docker push obekegodfreyvicent/node-k8s-demo:latest
...
kubectl create deployment node-k8s-demo --image=obekegodfreyvicent/node-k8s-demo:latest --dry-run=client -o yaml > deployment.yaml
